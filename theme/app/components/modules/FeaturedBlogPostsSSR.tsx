...
// SSR Note:
// hydrogen's Image component is client side optimized
// Using <img> ensures SSR compatibility
// clsx runs at build time
// Link component renders SSR as a standard <a> tag
...
export default function FeaturedBlogPosts({module}: Props) {
  // SSR Note: console.log removed here, no need for SSR
  return (
      ...
      <div className="flex flex-col gap-1 text-white md:flex-row md:flex-wrap xl:flex-nowrap">
        ...
        <div className={FEATURED_BLOG_POST_ITEM}>
          <div className={BLOG_POST_IMAGE_CONTAINER}>
            ...
            />
            <div className={BLOG_POST_IMAGE_OVERLAY} />
            {module.blogPosts[0]?.featuredImageMobile?.url && (
              <img
