...
import {flattenConnection, Image, SeoHandleFunction} from '@shopify/hydrogen';
import type {
                  ...
                  {lineItems.map((lineItem: OrderLineItem) => (
                    <tr key={lineItem.variant!.id}>
                        ...
                        <div className="flex gap-6">
                          ...
                          <dl className="grid">
                            ...
                            <dd className="truncate sm:hidden">
                              <div className="mt-4">
                                <Currency data={lineItem.variant!.price!} />
                              </div>
                            </dd>
                      ...
                      <td className="px-3 py-4 text-right align-top sm:table-cell sm:align-middle">
                        <Currency data={lineItem.discountedTotalPrice!} />
                      </td>
                    </tr>
                  ))}
                </tbody>
                <tfoot>
                    ...
                    <tr>
                      ...
                      <td className="pl-3 pr-4 pt-6 text-right font-medium text-green-700 md:pr-3">
                        {discountPercentage ? (
                          ...
                          discountValue && <Currency data={discountValue!} />
                        )}
                      </td>
                    </tr>
                  )}
                  <tr>
                    ...
                    <td className="pl-3 pr-4 pt-6 text-right md:pr-3">
                      <Currency data={order.subtotalPrice!} />
                    </td>
                  </tr>
                  <tr>
                    <th
                  ...
                  <tr>
                    ...
                    <td className="pl-3 pr-4 pt-4 text-right font-bold md:pr-3">
                      <Currency data={order.totalPrice!} />
                    </td>
                  </tr>
                </tfoot>
              </table>
